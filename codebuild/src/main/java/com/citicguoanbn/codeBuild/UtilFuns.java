 ...
 */
  ...
  */
  ...
  public static String dateTimeFormat1(Date date) throws ParseException {
	  String s ="";
	  try{
		  SimpleDateFormat dformat = new SimpleDateFormat("yyyy-MM-dd");
		  s = dformat.format(date);
  ...
  //add by tony 2011-07-26 返回英文格式日期 10.08.11
  public static String formatDateEN1(String date) throws ParseException {
	  String s ="";
	  int whichMonth = 1;
	  try{
		  if(UtilFuns.isEmpty(date)){
		 ...
		 String year = aString[0].substring(2);
		  s = aString[2]+"."+s+"."+year;
